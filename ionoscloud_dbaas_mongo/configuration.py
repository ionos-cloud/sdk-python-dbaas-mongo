...
conf = ionoscloud_dbaas_mongo.Configuration(
    token='AuthToken'
    token_prefix='Bearer'
)
...
conf = ionoscloud_dbaas_mongo.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.ionos.com/databases/mongodb" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ionoscloud_dbaas_mongo")
