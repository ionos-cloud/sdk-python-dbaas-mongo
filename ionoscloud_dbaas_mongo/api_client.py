...
import ionoscloud_dbaas_mongo.models
from ionoscloud_dbaas_mongo import rest
from ionoscloud_dbaas_mongo.exceptions import ApiValueError, ApiException, ApiFailedRequest, ApiTimeout
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ionoscloud_dbaas_mongo.models, klass)
